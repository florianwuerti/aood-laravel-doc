...
class PermissionController extends Controller {
	...
	public function store( Request $request ) {
		...
		if ( $request->permission_type == 'basic' ) {
			$this->validate( $request, [
				...
				'slug'         => 'required|alphadash|unique:permissions,name',
		...
		} elseif ( $request->permission_type == 'basic' ) {
			...
			if ( count( $crud ) > 0 ) {
				...
				Session::flash( 'succes' . 'Permissions were all successfully added' );
	...
	public function update( Request $request, $id ) {
		...
		Session::flash( 'succes', 'Updated the ' . $permission->dispaly_name . ' permission.' );
