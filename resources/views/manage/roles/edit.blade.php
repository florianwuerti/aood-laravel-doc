                        ...
                        <article class="media">
                            <div class="media-content">
                                <div class="content">
                                    ...
                                    <div class="field">
                                        <p class="control">
                                            ...
                                            <input type="text" class="input" name="display_name"
                                                   value="{{$role->display_name}}" id="display_name">
                                        </p>
                                    </div>
                                    <div class="field">
                                        <p class="control">
                                    ...
                                    <input type="hidden" name="permission" value="permissionsSelected">
                                </div>
                            </div>
                        </article>
                    </div>
                            ...
                            <div class="media-content">
                                <div class="content">
                                    ...
                                    @foreach ($permissions as $permission)
                                        <div class="field">
                                            <b-checkbox name="permissions" v-model="permissionsSelected"
